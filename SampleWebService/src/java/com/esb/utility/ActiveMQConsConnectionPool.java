 ...
 * @author Haris Tanwir
 */
public class ActiveMQConsConnectionPool {
    ...
    public ActiveMQConsConnectionPool(String ip, Integer port) {
        this.ip = ip;
        this.port = port;
    ...
    private ActiveMQConnection getConnection(String queueName) {
        ...
        System.out.println(mqConnectionList.size());
            ...
            synchronized (mqConnectionList) {
                if (!mqConnectionList.isEmpty()) {
                    ...
                    try {
                        ...
                        mqConnection = new ActiveMQConnection(connection, session, destination, consumer, null);
